      ...
      <div className="lg:col-span-2 sticky top-24">
        <Card className="min-h-[500px]">
          <CardHeader>
            ...
            <CardDescription>
              {selectedItem ? `Forecast for ${selectedItem.name} in ${selectedItem.location.zipCode}` : "Real-time predictive insights will appear here."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="bg-secondary/50 p-4 rounded-lg mb-6">
              ...
              {selectedItem && (
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                  ...
                  <p><span className="font-medium text-muted-foreground">Zip Code:</span> {selectedItem.location.zipCode}</p>
